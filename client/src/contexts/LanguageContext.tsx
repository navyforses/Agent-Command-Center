...
const translations: Record<string, Record<Language, string>> = {
  ...
  regenerate: { en: "Regenerate", ka: "თავიდან გენერირება" },
  regenerating: { en: "Regenerating...", ka: "გენერირდება..." },
  regenerateSuccess: { en: "Report regenerated successfully", ka: "ანგარიში წარმატებით განახლდა" },
  regenerateError: { en: "Failed to regenerate report", ka: "ანგარიშის განახლება ვერ მოხერხდა" },
  ...
  medicalInfo: { en: "Medical Info", ka: "სამედიცინო ინფორმაცია" },
  therapies: { en: "Therapies", ka: "თერაპიები" },
  birthDate: { en: "Birth Date", ka: "დაბადების თარიღი" },
  activeTherapies: { en: "Active Therapies", ka: "აქტიური თერაპიები" },
  diagnosisDate: { en: "Diagnosis Date", ka: "დიაგნოზის თარიღი" },
  notes: { en: "Notes", ka: "ჩანაწერები" },
  therapyProgress: { en: "Therapy Progress", ka: "თერაპიის პროგრესი" },
  diagnosisInformation: { en: "Diagnosis Information", ka: "დიაგნოზის ინფორმაცია" },
  primaryDiagnosis: { en: "Primary Diagnosis", ka: "ძირითადი დიაგნოზი" },
  dateOfBirth: { en: "Date of Birth", ka: "დაბადების თარიღი" },
  notSpecified: { en: "Not specified", ka: "არ არის მითითებული" },
  noAdditionalNotes: { en: "No additional notes", ka: "დამატებითი ჩანაწერები არ არის" },
  currentTherapies: { en: "Current Therapies", ka: "მიმდინარე თერაპიები" },
  addTherapy: { en: "Add Therapy", ka: "თერაპიის დამატება" },
  therapy: { en: "Therapy", ka: "თერაპია" },
  noTherapistAssigned: { en: "No therapist assigned", ka: "თერაპევტი არ არის მინიჭებული" },
  noFrequencySet: { en: "No frequency set", ka: "სიხშირე არ არის დაყენებული" },
  active: { en: "Active", ka: "აქტიური" },
  paused: { en: "Paused", ka: "შეჩერებული" },
  noTherapiesYet: { en: "No therapies yet", ka: "თერაპიები ჯერ არ არის" },
  addTherapyToTrack: { en: "Add a therapy to start tracking progress", ka: "დაამატეთ თერაპია პროგრესის თვალყურისდევნებისთვის" },
  uploadDocument: { en: "Upload Document", ka: "დოკუმენტის ატვირთვა" },
  uploadMedicalDocument: { en: "Upload Medical Document", ka: "სამედიცინო დოკუმენტის ატვირთვა" },
  aiAnalyzed: { en: "AI Analyzed", ka: "AI გაანალიზებულია" },
  analysisPending: { en: "Analysis Pending", ka: "ანალიზი მიმდინარეობს" },
  unknownDate: { en: "Unknown date", ka: "უცნობი თარიღი" },
  aiAnalysisInProgress: { en: "AI analysis in progress...", ka: "AI ანალიზი მიმდინარეობს..." },
  noDocumentsYet: { en: "No documents yet", ka: "დოკუმენტები ჯერ არ არის" },
  uploadDocumentsToTrack: { en: "Upload medical documents to keep track of records", ka: "ატვირთეთ სამედიცინო დოკუმენტები ჩანაწერების შესანახად" },
  childNotFound: { en: "Child Not Found", ka: "ბავშვი ვერ მოიძებნა" },
  childNotFoundDescription: { en: "The child profile you're looking for doesn't exist or you don't have access to it.", ka: "ბავშვის პროფილი, რომელსაც ეძებთ, არ არსებობს ან არ გაქვთ წვდომა." },
  backToDashboard: { en: "Back to Dashboard", ka: "მთავარ გვერდზე დაბრუნება" },
  notSet: { en: "Not set", ka: "არ არის დაყენებული" },
  unknown: { en: "Unknown", ka: "უცნობი" },
  months: { en: "months", ka: "თვე" },
  years: { en: "years", ka: "წელი" },
};
